function [s_ac,R0_RCMC,Parameter] = RDA_imaging2_v2(raw_data_type)
% 对函数 RDA_imaging2（）进行了一些修改，使得该函数用于
% “2014.12.19.改进了原始回波生成的程序”中生成的原始回波数据的成像处理；
% 该版本记为：RDA_imaging2_v2（）
%
% 本函数用来对生成的原始数据成像
% 利用：
